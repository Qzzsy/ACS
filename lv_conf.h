...
#define LV_VDB_SIZE         (32 * 480)  /*Size of VDB in pixel count (1/10 screen size is good for first)*/
#define LV_VDB_ADR          0x10000000                  /*Place VDB to a specific address (e.g. in external RAM) (0: allocate automatically into RAM)*/
